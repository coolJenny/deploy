...
class Skynet < ApplicationRecord
  ...
  belongs_to :user
  belongs_to :vendor
  belongs_to :skynet_id_type
  belongs_to :skynet_status
  validates :skynet_status_id, presence: true
  validates :skynet_id_type_id, presence: true
